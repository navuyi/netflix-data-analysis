...
def scores_distribution_per_user(tester_id, video_id):
    distribution = {'bad': 0, 'poor': 0, 'average': 0, 'good': 0, 'excellent': 0}
    data = assessment_data(fields, video_id)
    ...
    ax2.set_title(f'Score distribution {tester_id}_{video_id}', fontsize=10)
